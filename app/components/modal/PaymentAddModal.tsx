  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="bg-green-500 border-none text-white px-8 py-4 text-center no-underline inline-block text-lg mx-1 my-0.5 cursor-pointer rounded-full w-full">
          결제 내역 추가하기
        </div>
      </div>
    </div>
